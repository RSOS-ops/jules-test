...
spotLight.intensity = 35; // Adjusted intensity
spotLight.distance = 1; // Maximum range of the light (covers the 5-unit placement from model origin)
spotLight.angle = Math.PI / 9; // Cone angle in radians (15 degrees for a wider cone).
